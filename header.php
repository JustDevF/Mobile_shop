...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        ...
        <div class="font-rale font-size-14">
            <!--empêcher l'utilisateur de voir la page connexion s'il est deja connecté-->
            ...
            <a href="<?php echo isset($_SESSION['Id_User_Connected']) ? "": "inscription.php" ?>"   class="px-3 border-right text-dark"><?php echo isset($user['first_name'])? $user['first_name']." ".$user['last_name'] : 'Inscription'?></a></a>
        </div>
    </div>
